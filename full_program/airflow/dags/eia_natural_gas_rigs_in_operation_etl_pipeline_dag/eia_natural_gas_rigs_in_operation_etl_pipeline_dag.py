...
from eia_natural_gas_rigs_in_operation_etl_pipeline_dag.extraction import natural_gas_rigs_in_operation_extraction
from eia_natural_gas_rigs_in_operation_etl_pipeline_dag.drop_columns import drop_columns
from eia_natural_gas_rigs_in_operation_etl_pipeline_dag.drop_nulls import drop_nulls
from eia_natural_gas_rigs_in_operation_etl_pipeline_dag.pivot_data import pivot_data
...
with DAG(dag_id='natural_gas_rigs_in_operation_etl_pipeline', default_args=default_args, schedule_interval = timedelta(30), 
